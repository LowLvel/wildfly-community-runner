...
10. Sensitive JVM properties (in progress): PasswordSafe references, background migration and dialogs, private argument files, credential-store failure and concurrent-edit guards, chunked output redaction, and actual Java/Gradle subprocess fixtures.
