...
11. Server log viewer (in progress): bounded UTF-8 tail, rotation/truncation recovery, complete-line redaction, visibility/pause/filter/follow controls, and stale callback expiry.
